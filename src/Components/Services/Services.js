    ...
    return (
        <div className='mx-36 my-16'>
            <div className='grid grid-cols-3'>
                <div className='card shadow-lg h-[428px] w-[360px] p-10 items-center hover:scale-105 hover:border-primary hover:border-2 transition duration-700'>
            ...
            <div className='w-[820px] mx-auto flex items-center mt-20'>
                <div className='card shadow-lg h-[428px] w-[360px] p-10 items-center mr-20 hover:scale-105 hover:border-primary hover:border-2 transition duration-700'>
