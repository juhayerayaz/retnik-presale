    ...
    return (
        <div className='grid grid-cols-3 mx-80 gap-y-11 my-24'>
            <div>
                ...
                <h1 className='text-lg mt-3 mb-1'>Logos</h1>
                <hr className='bg-primary border-primary mb-8 border-t-4 w-[80px]' />
            ...
            <div>
                ...
                <h1 className='text-lg mt-3 mb-1'>Blog Writing</h1>
                <hr className='bg-primary border-primary mb-8 border-t-4 w-[80px]' />
            ...
            <div>
                ...
                <h1 className='text-lg mt-3 mb-1'>Animated Videos</h1>
                <hr className='bg-primary border-primary mb-8 border-t-4 w-[80px]' />
            ...
            <div>
                ...
                <h1 className='text-lg mt-3 mb-1'>Product Demo</h1>
                <hr className='bg-primary border-primary mb-8 border-t-4 w-[80px]' />
            ...
            <div>
                ...
                <h1 className='text-lg mt-3 mb-1'>Copywriting</h1>
                <hr className='bg-primary border-primary mb-8 border-t-4 w-[80px]' />
            ...
            <div>
                ...
                <h1 className='text-lg mt-3 mb-1'>Social Media ADs</h1>
                <hr className='bg-primary border-primary mb-8 border-t-4 w-[80px]' />
